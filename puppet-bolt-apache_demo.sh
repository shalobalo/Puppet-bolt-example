...
echo "\tExample: 'bolt plan run lab::apache --run-as root --no-host-key-check -t 35.204.48.78 --private-key ~/.ssh/google_compute_engine -u username'"%
